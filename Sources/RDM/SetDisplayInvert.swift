 ...
 */
public struct SetDisplayInvert: MessageDataBlockProtocol, Equatable, Hashable {
...
public extension SetDisplayInvert {
...
extension SetDisplayInvert: DataConvertible {
    
    var dataLength: Int {
        return MemoryLayout<DisplayInvertSetting>.size
    }
    
    static func += (data: inout Data, value: SetDisplayInvert) {
