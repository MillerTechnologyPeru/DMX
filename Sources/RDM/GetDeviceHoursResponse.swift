 ...
 */
public struct GetDeviceHoursResponse: MessageDataBlockProtocol, Equatable, Hashable {
...
public extension GetDeviceHoursResponse {
...
extension GetDeviceHoursResponse: DataConvertible {
    
    var dataLength: Int {
        return MemoryLayout<UInt32>.size
    }
    
    static func += (data: inout Data, value: GetDeviceHoursResponse) {
