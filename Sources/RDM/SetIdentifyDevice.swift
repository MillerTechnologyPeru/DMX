 ...
 */
public struct SetIdentifyDevice: MessageDataBlockProtocol, Equatable, Hashable {
...
public extension SetIdentifyDevice {
...
extension SetIdentifyDevice: DataConvertible {
    
    var dataLength: Int {
        return MemoryLayout<UInt8>.size
    }
    
    static func += (data: inout Data, value: SetIdentifyDevice) {
