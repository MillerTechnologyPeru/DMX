//
//  GetDMX512StartingAddressResponse.swift
//  
//
 ...
 */
public struct GetDMX512StartingAddressResponse: MessageDataBlockProtocol, Equatable, Hashable {
    ...
    public init(address: UInt16) {
        assert(GetDMX512StartingAddressResponse.range.contains(address) || address == UInt16.max)
...
public extension GetDMX512StartingAddressResponse {
...
extension GetDMX512StartingAddressResponse: DataConvertible {
    
    var dataLength: Int {
        return MemoryLayout<UInt16>.size
    }
    
    static func += (data: inout Data, value: GetDMX512StartingAddressResponse) {
