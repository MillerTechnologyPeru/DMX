 ...
 */
public struct SetDisplayLevel: MessageDataBlockProtocol, Equatable, Hashable {
...
public extension SetDisplayLevel {
...
extension SetDisplayLevel: DataConvertible {
    
    var dataLength: Int {
        return MemoryLayout<UInt8>.size
    }
    
    static func += (data: inout Data, value: SetDisplayLevel) {
