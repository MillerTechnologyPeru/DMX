 ...
 */
public struct GetLampHoursResponse: MessageDataBlockProtocol, Equatable, Hashable {
...
public extension GetLampHoursResponse {
...
extension GetLampHoursResponse: DataConvertible {
    
    var dataLength: Int {
        return MemoryLayout<UInt32>.size
    }
    
    static func += (data: inout Data, value: GetLampHoursResponse) {
